...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("INSERT INTO trails (name, description, location, difficulty, image) VALUES (?, ?, ?, ?, ?)");
    $stmt->execute([$name, $description, $location, $difficulty, $image]);
            ...
            <div class="form-content">
                <form method="POST" enctype="multipart/form-data" id="trailForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="location" name="location" placeholder="e.g., Benguet Province, Philippines">
                        <div class="helper-text">Specify the geographic location or starting point</div>
                    </div>
